...
React Router provides built-in utilities for cookie-based session management. **Always use these instead of hand-rolling
...
**Gotcha:** With nested routes, multiple loaders run in parallel. If you use flash data, ensure only one loader reads it
