...
* :func:`start_anonymous_session` — the standalone anonymous-login helper,
  delegating to :func:`exegia.supabase.authentication.sign_in_anonymously`.
...
from exegia.auth.current_user import (
    USERS_ID_COLUMN,
    USERS_TABLE,
    CurrentUser,
    get_profile,
...
def start_anonymous_session(
    *,
    ...
    Thin delegate to :func:`exegia.supabase.authentication.sign_in_anonymously`,
