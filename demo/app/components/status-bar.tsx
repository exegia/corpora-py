...
import type { BridgeMessage, BridgeStatus } from "@/types/socket"
import { Chip, ChipRootProps, Typography } from "@heroui/react"
import { Check, Clock, CloudOff, Stop } from "@untitledui/icons"
import {Button} from '@astryxdesign/core/Button';
import { SVGAttributes } from "react"

type ChipStatus = ChipRootProps['color']
type ChipStatusMap<T extends BridgeStatus = BridgeStatus> = Record<T, { color: ChipStatus, icon: React.FC<SVGAttributes<SVGSVGElement>>, label: T }>
...
export const StatusBar = () => {
  ...
  return (
    <div className="flex flex-row w-full items-center absolute left-0 bottom-0">
      <div className="bg-white/80 dark:bg-neutral-700/30 backdrop-blur-md mx-auto px-3 py-2 mb-3 rounded-xl flex flex-row items-center gap-2 justify-between w-lg">
