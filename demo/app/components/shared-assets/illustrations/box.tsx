...
export const sm = ({
    ...
    return (
        ...
        <svg viewBox="0 0 152 126" fill="none" className={cx("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="76" cy="60" r="52" className="fill-utility-neutral-100 dark:fill-utility-neutral-800" />
                <circle cx="21" cy="27" r="5" className="fill-utility-neutral-100 dark:fill-utility-neutral-800" />
                <circle cx="18" cy="111" r="7" className="fill-utility-neutral-100 dark:fill-utility-neutral-800" />
                <circle cx="145" cy="43" r="7" className="fill-utility-neutral-100 dark:fill-utility-neutral-800" />
                <circle cx="134" cy="16" r="4" className="fill-utility-neutral-100 dark:fill-utility-neutral-800" />
              ...
              />
                ...
                <defs>
                    ...
                    <linearGradient id="box-gradient-sm" x1="97" y1="20.375" x2="128.011" y2="74.9366" gradientUnits="userSpaceOnUse">
                        <stop stopColor="currentColor" className="text-utility-neutral-500" />
    ...
    return (
        <div {...otherProps} className={cx("relative h-37 w-43", className)}>
            <svg viewBox="0 0 172 148" fill="none" className={cx("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="86" cy="74" r="64" className="fill-utility-neutral-100 dark:fill-utility-neutral-800" />
                <circle cx="20" cy="30" r="6" className="fill-utility-neutral-100 dark:fill-utility-neutral-800" />
                <circle cx="17" cy="122" r="8" className="fill-utility-neutral-100 dark:fill-utility-neutral-800" />
                <circle cx="160" cy="46" r="8" className="fill-utility-neutral-100 dark:fill-utility-neutral-800" />
                <circle cx="149" cy="19" r="5" className="fill-utility-neutral-100 dark:fill-utility-neutral-800" />
                <g filter="url(#box-shadow-md)">
                    <path d="M86.0007 113.664L138 90.5625V24.75L86.4084 2L34 24.75V90.5625L86.0007 113.664Z" className="fill-utility-neutral-50 dark:fill-utility-neutral-900" />
                    <path
                        ...
                        className="stroke-border-secondary_alt"
                    />
                    <path d="M86 46.6493V113.719L34 90.5625V24.75L86 46.6493Z" className="fill-utility-neutral-200 dark:fill-neutral-950" />
                    <path d="M86.001 46.6875V113.719L138 90.5625V24.75L86.001 46.6875Z" fill="url(#box-gradient-md)" />
                    <path d="M86 46.6875L138 24.75L86.4084 2L34 24.75L86 46.6875Z" className="fill-utility-neutral-50 dark:fill-neutral-900" />
                    <path
                        d="M53.9062 16.1072L105.404 38.5221L105.874 54.9531L120.368 48.9727L119.93 32.438L66.7906 10.5205L53.9062 16.1072Z"
                        className="fill-utility-neutral-200 dark:fill-utility-neutral-800"
                    />
                </g>
                <defs>
                    <filter
                    ...
                    <linearGradient id="box-gradient-md" x1="112" y1="24.75" x2="150.395" y2="92.3024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="currentColor" className="text-utility-neutral-500 dark:text-utility-neutral-600" />
                        <stop offset="1" stopColor="currentColor" className="text-utility-neutral-200 dark:text-utility-neutral-900" />
                    </linearGradient>
                </defs>
            </svg>
    ...
    return (
        <div {...otherProps} className={cx("relative h-45.25 w-55", className)}>
            <svg viewBox="0 0 220 181" fill="none" className={cx("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="110" cy="90" r="80" className="fill-utility-neutral-100 dark:fill-utility-neutral-800" />
                <circle cx="26" cy="30" r="8" className="fill-utility-neutral-100 dark:fill-utility-neutral-800" />
                <circle cx="198" cy="136" r="6" className="fill-utility-neutral-100 dark:fill-utility-neutral-800" />
                <circle cx="25" cy="148" r="10" className="fill-utility-neutral-100 dark:fill-utility-neutral-800" />
                <circle cx="210" cy="56" r="10" className="fill-utility-neutral-100 dark:fill-utility-neutral-800" />
                <circle cx="191" cy="21" r="7" className="fill-utility-neutral-100 dark:fill-utility-neutral-800" />
                <g filter="url(#box-shadow-lg)">
                    <path d="M110.001 139.432L174 111V30L110.503 2L46 30V111L110.001 139.432Z" className="fill-utility-neutral-500" />
                    <path
                        ...
                        className="stroke-border-secondary_alt"
                    />
                    <path d="M110 56.9531V139.5L46 111V30.0001L110 56.9531Z" className="fill-utility-neutral-500" />
                    <path d="M110.001 57V139.5L174 111V30L110.001 57Z" fill="url(#box-gradient-lg)" />
                    <path d="M110 57L174 30L110.503 2L46 30L110 57Z" className="fill-utility-neutral-500" />
                    <path
                        d="M70.5 19.3627L133.882 46.9503L134.461 67.173L152.299 59.8125L151.759 39.4622L86.3577 12.4868L70.5 19.3627Z"
                        className="fill-utility-neutral-500"
                    />
                </g>
                <defs>
