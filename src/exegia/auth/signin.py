...
:mod:`exegia.supabase.authentication` and adds the application-level step that
...
:class:`~exegia.auth.current_user.CurrentUser` payload (the ``auth.users``
...
from exegia.auth.current_user import CurrentUser, get_profile
from exegia.supabase import authentication
from exegia.supabase.authentication import IdTokenProvider
